...
class TestConfigPersistence:
    ...
    def test_example_config_documents_runtime_settings(self):
        ...
        assert "mimo_tts_model_name" in app_config
        ...
        for removed in (
            ...
            assert removed not in app_config
        assert "whisper" not in example_config
        assert "ui" not in example_config
