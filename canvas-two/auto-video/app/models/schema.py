...
class MaterialStorageData(BaseModel):
    dir: str
    default_dir: str
    custom: bool


class MaterialStorageSettingsResponse(BaseResponse):
    ...
    model_config = ConfigDict(
        json_schema_extra={
            "example": {
                ...
                "message": "success",
                "data": {
                    "dir": "/data/local_videos",
                    "default_dir": "/MoneyPrinterTurbo/storage/local_videos",
                    "custom": True,
                },
            },
        }
...
class MaterialStorageUpdateRequest(BaseModel):
    # 传空字符串或 null 表示恢复默认存储位置。
