...
export type AgentCanvasContext = { snapshot: CanvasAgentSnapshot; readOnly: boolean; applyOps: (ops?: CanvasAgentOp[]) => CanvasAgentSnapshot; undoOps: () => CanvasAgentSnapshot | null; canUndo: boolean };
